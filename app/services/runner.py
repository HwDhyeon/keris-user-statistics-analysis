...
def _persist_success(
    ...
    analysis.chart_data = rec_service.build_chart_data(outcome, analysis.method, chart_options)
...
def _persist_failure(session: Session, analysis: Analysis, message: str, started: float) -> None:
...
def rebuild_chart_data(
    session: Session, analysis: Analysis, options: ChartDataOptions
) -> Analysis:
